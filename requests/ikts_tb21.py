...
driver.get('https://stud.sssu.ru/WebApp/#/Rasp/Group/23141')
sleep(7)
...
base.execute('CREATE TABLE IF NOT EXISTS {}(name)'.format('ikts_tb21'))
base.commit()

try:
    name_week = driver.find_element_by_xpath('//*[@id="input-176"]"]').text
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (name_week,))
    base.commit()
except:
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_time_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_name_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_teacher_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_aud_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
##1 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_time_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_name_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_teacher_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_aud_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##2 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_time_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_name_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_teacher_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_aud_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##3 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_time_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_name_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_teacher_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_aud_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##4 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_time_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_name_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_teacher_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (monday_aud_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##5 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_time_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_name_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_teacher_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_aud_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
##1 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_time_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_name_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_teacher_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_aud_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##2 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_time_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_name_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_teacher_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_aud_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##3 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_time_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_name_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_teacher_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_aud_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##4 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_time_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_name_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_teacher_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (tuesday_aud_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##5 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_time_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_name_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_teacher_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_aud_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
##1 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_time_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_name_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_teacher_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_aud_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##2 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_time_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_name_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_teacher_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_aud_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##3 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_time_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_name_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_teacher_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_aud_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##4 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_time_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_name_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_teacher_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (wednesday_aud_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##5 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_time_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_name_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_teacher_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_aud_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
##1 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_time_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_name_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_teacher_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_aud_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##2 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_time_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_name_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_teacher_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_aud_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##3 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_time_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_name_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_teacher_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_aud_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##4 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_time_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_name_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_teacher_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (thursday_aud_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##5 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_time_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_name_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_teacher_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_aud_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
##1 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_time_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_name_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_teacher_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_aud_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##2 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_time_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_name_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_teacher_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_aud_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##3 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_time_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_name_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_teacher_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_aud_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##4 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_time_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_name_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_teacher_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (friday_aud_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##5 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_time_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_name_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_teacher_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_aud_1,))
    base.commit()
except:
    print ("Значений не найдено, пропускаю")
##1 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_time_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_name_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_teacher_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_aud_2,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##2 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_time_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_name_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_teacher_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_aud_3,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##3 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_time_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_name_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_teacher_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_aud_4,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##4 пара (конец)
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_time_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_name_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_teacher_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
...
try:
    ...
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', (saturday_aud_5,))
    base.commit()
except:
    print("Значений не найдено, пропускаю")
##5 пара (конец)
...
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "Понедельник", "📌 Понедельник 📌")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "Вторник", "📌 Вторник 📌")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "Среда", "📌 Среда 📌")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "Четверг", "📌 Четверг 📌")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "Пятница", "📌 Пятница 📌")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "Суббота", "📌 Суббота 📌")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "08:30", "🕗 08:30")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "10:05", "🕙 10:05")')

cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "10:20", "🕙 10:20")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "11:55", "🕛 11:55")')

cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "12:30", "🕛 12:30")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "14:05", "🕑 14:05")')

cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "14:20", "🕑 14:20")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "15:55", "🕓 15:55")')

cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "16:10", "🕔 16:10")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "17:45", "🕡 17:45")')

#cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "Аудитория:", "🏢 Аудитория:")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "пр.", "📝 пр.")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "лек", "📖 лек")')
cur.execute('UPDATE ikts_tb21 SET name = REPLACE (name, "лаб", "🔬 лаб")')

#Проверка на пустую строку в БД
noname = cur.execute('SELECT name FROM ikts_tb21').fetchall()
print(noname)

if noname == ([]):
    print("База пуста")
    cur.execute('INSERT INTO ikts_tb21 VALUES(?);', ('Занятий не найдено',))
else:
    print("База не пуста")
#Проверка на пустую строку в БД
